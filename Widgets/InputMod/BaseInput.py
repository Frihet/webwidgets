...
class NewPasswordInput(Webwidgets.Widgets.FormattingMod.BaseFormatting.Html, Webwidgets.Widgets.Base.ValueInput):
    ...
    def __init__(self, session, win_id, **attrs):
        Webwidgets.Widgets.FormattingMod.BaseFormatting.Html.__init__(
            self, session, win_id,
            **attrs)
...
class FileInput(Webwidgets.Widgets.Base.ValueInput, Webwidgets.Widgets.Base.StaticComposite):
    ...
    class Preview(Webwidgets.Widgets.FormattingMod.BaseFormatting.Media):
