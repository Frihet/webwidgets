...
<cfparam name="attributes.menuname" default="#attributes.id#">
...
<cfif  ThisTag.HasEndTag>
	...
	<cfif ThisTag.ExecutionMode is "End">
		...
		<cfoutput>
			<span id="#attributes.id#">#ThisTag.GeneratedContent#</span><script>#attributes.menu#.setContextZone('#attributes.id#','#attributes.menuname#'); </script>
		</cfoutput>
	</cfsavecontent>
...
<cfelse>
	<!--- [ register    ] --->
	<cfoutput>
	<script>#attributes.menu#.setContextZone('#attributes.id#','#attributes.menuname#'); </script>
	</cfoutput>	
